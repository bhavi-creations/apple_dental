...
<head>
  ...
  <style>
    ...
    .navbar {
      ...
      /* Explicitly target background color */
    }
    ...
    .home-slider {
      overflow: hidden;
      /* Prevent unwanted scrolling inside the slider */
    }

    .slider-item {
      overflow: auto;
      /* Allow content to scroll inside individual slides if needed */
      touch-action: pan-y;
...
<section class="marquee-section">
    <div class="marquee_content">
      <marquee behavior="scroll" direction="left" class="marquee">
       <p>
       Apple Dental Care: Your Trusted Partner for Comprehensive Oral Health. &nbsp; &nbsp;&nbsp;&nbsp; Experience the Future of Dentistry with Apple Dental Care’s Advanced Solutions
       </p>
  ...
  <section class="navbar-section d-none d-lg-block">
    <nav class="navbar navbar-expand-lg navbar-light navbar-center header_background footer_content" style="background-color: #4c7ebb
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="app_bg text text-center text-white" href="appointment.php">Make Appointment</a>
            </li>
          </ul>
        </div>
      </div>
