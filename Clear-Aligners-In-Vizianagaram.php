<?php
$meta_title = "Clear Aligners in Vizianagaram | Apple Dental Specialities";
$meta_description = "Straighten your teeth discreetly with clear aligners in Vizianagaram. Comfortable, removable & effective for all ages. Book a free consultation.";
include 'header.php';
?>
...
<!-- <section class="mt-5">
<div class="container">
<h2>Clear Aligners in Vizianagaram | Apple Dental Specialities</h2>
    <p>Clear Aligners in Vizianagaram are a modern orthodontic solution for straightening teeth without traditional braces. They are nearly invisible, removable, and custom-made for a comfortable fit. Aligners gradually shift teeth into place, providing an effective and discreet way to achieve a perfect smile.
            ...
            <div class="col-xl-6 col-lg-6 col-md-12">
                ...
                <div class="service_new_first_section_content">
                    ...
                    <p class="service_new_first_section_description">
                        ...
                        Clear Aligners in Vizianagaram are a modern orthodontic
                        solution for straightening teeth without traditional braces.
                        They are nearly invisible, removable, and custom-made for
                        a comfortable fit. Aligners gradually shift teeth into place,
                        providing an effective and discreet way to achieve a perfect smile.
    ...
    <div class="row g-4">
        <div class="col-md-4">
            <div class="card shadow">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="card-text"> A digital scan or impression is taken to design custom aligners.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="card-text">  The patient wears a series of aligners, changing them every few weeks
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                ...
                <div class="card-body text-center">
                    <h5 >Step 3:</h5>
                    <p class="card-text">After treatment, a retainer is used to maintain the new smile</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                      ...
                      1)  Misaligned, crowded, or gapped teeth
                            <br>
                            2)  Desire for a discreet orthodontic solution without metal braces
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">1)  Difficulty in chewing or speaking due to misalignment<br>
                            2)  Jaw pain or discomfort from improper bit
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <img src="images1/services/services_img/s2.png" class="card-img-top" alt="Clear Aligners in Vizianagaram">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            1) Custom-made, transparent trays worn over teeth to gradually shift alignment
                            <br>
                            2) Regular aligner changes every 1-2 weeks as per the treatment plan
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            1)  Wear retainers to maintain new tooth position
                            <br>
                            2)Maintain good oral hygiene and regular dental checkups
                        </p>
                    </div>
                </div>
            </div>
...
<section class="service_new_second_section">
    ...
    <div class="service_new_second_section_left_note">
        ...
        <div>
            <span>DISCREET CARE</span>
            <span>STRAIGHTER TEETH</span>
    ...
    <div class="container-fluid service_new_second_section_container">
        ...
        <div class="service_new_second_section_header">
            ...
            <div class="service_new_second_section_eyebrow">
                ...
                <p>
                    A CLEARER WAY TO A CONFIDENT SMILE
                </p>
        ...
        <div class="service_new_second_section_process">
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        We examine your teeth, bite and alignment
                        concerns to determine whether clear aligners
                        are suitable for your smile.
                    </p>
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        A precise digital scan of your teeth is taken
                        to create an accurate 3D model without
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        Your tooth movements are digitally planned
                        step by step so you can understand the
                        expected smile transformation.
                    </p>
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        A customized series of transparent aligners
                        is created to gradually guide your teeth
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        Wear each aligner as advised and switch to
                        the next set according to your treatment
                        schedule for gradual tooth movement.
                    </p>
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        Regular review visits help us monitor tooth
                        movement, check the aligner fit and keep
                        your treatment progressing as planned.
                    </p>
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        After alignment is complete, retainers help
                        maintain the corrected tooth positions and
