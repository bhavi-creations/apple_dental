...
<head>
    ...
    <title>Apple dental Specialities </title>
    ...
    <style>
        ...
        .custom-menu {
            border-top: 1px solid #043494;
            border-bottom: 1px solid #043494;
            padding: 10px 0;
            margin: 20px 0;
            display: flex;
            ...
            <div class="col-lg-8">
                <div class="doctor-card-premium">
                    <div class="doctor-image-wrapper">
                        <img src="images1/kalyan.png" class="doctor-profile-img" alt="Dr. Kiran">
                        <div class="experience-badge">24 years Exp</div>
                    </div>
                    <div class="doctor-info">
                        <div class="doctor-title-area">
                            <h2 class="doctor-name">Dr. Kalyan Chakravarty</h2>
                            <span class="doctor-degree">Rotary Endodontics, Laser Dentistry, Dental Implants, and Smile Designing</span>
                        </div>
                ...
                <h4 class="fw-bold mb-4 d-flex justify-content-center py-3" id="title-1" style="color: #043494;"><?php echo $blog['title']; ?></h4>

                <div class="row align-items-center mb-4">
                    <div class="col-lg-7 order-2 order-lg-1">
                        <div class="content-box overlap-right">
                            <p class="text-#043494 small mb-0" id="short-1"><?php echo getLimitWords($blog['main_content'], 15); ?>...</p>
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-lg-7">
                            <div class="content-box overlap-left">
                                <p class="text-#043494 small mb-0" id="short-2"><?php echo getLimitWords($blog['full_content'], 15); ?>...</p>
