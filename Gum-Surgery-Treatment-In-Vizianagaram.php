<?php
$meta_title = "Gum Surgery in Vizianagaram | Apple Dental Specialities";
$meta_description = "Advanced gum surgery in Vizianagaram for periodontal disease, gum recession & more. Skilled periodontists using modern techniques. Book now.";
include 'header.php';
?>
...
<!-- <section class="mt-5">
    <div class="container">
        <h2>Gum Surgery in Vizianagaram</h2>
        <p>Gum Surgery in Vizianagaram is a dental procedure to treat gum disease, reshape the gum line, or restore gum health. It helps reduce gum recession, remove infected tissue, and strengthen the support for teeth. This procedure improves both oral health and the appearance of the gums.
            ...
            <div class="col-xl-6 col-lg-6 col-md-12"> 
                ...
                <div class="service_new_first_section_content"> 
                    ...
                    <p class="service_new_first_section_description"> 
                        ...
                        Gum Surgery in Vizianagaram is a dental procedure to treat gum 
                        disease, reshape the gum line, or restore gum health. It helps 
                        reduce gum recession, remove infected tissue, and strengthen 
                        the support for teeth. This procedure improves both oral health 
                        and the appearance of the gums.
...
<div class="container mt-5">
    <div class="row g-4">
        <div class="col-md-4">
            <div class="card shadow">
                <div class="overflow-hidden">
                    <img src="images1/services/services_img/gumsergery.png" class="card-img-top" alt="Image 1">
                </div>
                <div class="card-body text-center">
                    <h5 class="card-title">Step 1:</h5>
                    <p class="card-text"> The dentist numbs the area and makes small incisions to access the gums.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="overflow-hidden">
                    <img src="images1/services/services_img/28.png" class="card-img-top" alt="Image 2">
                </div>
                <div class="card-body text-center">
                    <h5 class="card-title">Step 2:</h5>
                    <p class="card-text"> Diseased tissue is removed, and the gums are reshaped or grafted if needed.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="overflow-hidden">
                    <img src="images1/services/services_img/29.png" class="card-img-top" alt="Image 3">
                </div>
                <div class="card-body text-center">
                    <h5 >Step 3:</h5>
                    <p class="card-text">The gums are sutured back in place, and proper aftercare ensures healing</p>
                </div>
            </div>
        </div>
    </div>
