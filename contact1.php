        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4" data-aos="fade-left" data-aos-delay="200">
                <div class="contact-info" style="background: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                    ...
                    <p><i class="fas fa-map-marker-alt icon p-2" style="color: #007bff; margin-right: 10px;"></i> D.No.22-1-10, 1st Floor, A.G. Complex, Phool Baugh Road, Near Ambatisatram Jn., Vizianagaram - 535 002</p>
                    <p><i class="fas fa-phone icon  p-2" style="color: #007bff; margin-right: 10px;"></i> +91 9293056083</p>
                    <p><i class="fas fa-envelope icon  p-2" style="color: #007bff; margin-right: 10px;"></i> info@appledentalvzm.in</p>
                    <p><i class="fas fa-clock icon  p-2" style="color: #007bff; margin-right: 10px;"></i> Mon-Sun: 9 AM - 8 PM
