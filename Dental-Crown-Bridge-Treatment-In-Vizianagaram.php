            ...
            <div class="col-xl-6 col-lg-6 col-md-12"> 
                ...
                <div class="service_new_first_section_content"> 
                    ...
                    <div class="service_new_first_section_top_title"> 
                        ...
                        <span>DENTAL CROWNS &amp; BRIDGES</span> 
                    ...
                    <p class="service_new_first_section_description"> 
                        ...
                        Dental Crowns &amp; Bridges in Vizianagaram are dental restorations
                        used to restore damaged or missing teeth. A crown covers a weakened
                        tooth to protect and strengthen it, while a bridge replaces missing
                        teeth by anchoring to adjacent teeth. These solutions improve
                        function, appearance, and oral health.
...
<div class="container mt-5">
    <div class="row g-4">
        <div class="col-md-4">
            <div class="card shadow">
                <div class="overflow-hidden">
                    <img src="images1/services/services_img/crown1.png" class="card-img-top" alt="Image 1">
                </div>
                <div class="card-body text-center">
                    <h5 class="card-title">Step 1:</h5>
                    <p class="card-text">The dentist prepares the tooth/teeth and takes impressions for a custom fit.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="overflow-hidden">
                    <img src="images1/services/services_img/crown2.png" class="card-img-top" alt="Image 2">
                </div>
                <div class="card-body text-center">
                    <h5 class="card-title">Step 2:</h5>
                    <p class="card-text"> A temporary crown or bridge is placed while the permanent one is crafted.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="overflow-hidden">
                    <img src="images1/services/services_img/crown3.png" class="card-img-top" alt="Image 3">
                </div>
                <div class="card-body text-center">
                    <h5 >Step 3:</h5>
                    <p class="card-text">The final crown or bridge is securely bonded, restoring your smile and bite.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                      ...
                      1)  Damaged or weakened teeth needing protection
                            <br>
                            2)  Missing teeth affecting chewing and speech
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">1) Cracked, worn-down, or severely decayed teeth<br>
                            2)  Gaps in teeth leading to bite misalignment  
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            1) Custom-made crowns placed over damaged teeth for strength
                            <br>
                            2)Bridges used to replace missing teeth by anchoring to adjacent teeth
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            1)Maintain good oral hygiene to protect crowns and bridges
                            <br>
                            2) Avoid sticky or hard foods to prevent damage
                        </p>
                    </div>
                </div>
            </div>
...
<section class="service_new_second_section">
    ...
    <div class="service_new_second_section_left_note">
        ...
        <div>
            ...
            <span>PROTECT TEETH</span>
            <span>COMPLETE YOUR SMILE</span>
        </div>
    ...
    <div class="service_new_second_section_mirror">
        ...
        <img src="assets/img/services/crown-bridge-side.png"
             alt="Dental Crown and Bridge Treatment">
    ...
    <div class="container-fluid service_new_second_section_container">
        ...
        <div class="service_new_second_section_header">
            ...
            <div class="service_new_second_section_eyebrow">
                ...
                <p>
                    RESTORING STRENGTH, FUNCTION &amp; YOUR SMILE
                </p>
        ...
        <div class="service_new_second_section_process">
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        We examine the damaged or missing teeth,
                        gums and bite to determine the most suitable
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        Digital imaging helps assess tooth roots,
                        supporting teeth and surrounding structures
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        The supporting tooth is carefully shaped
                        so the crown or bridge can fit securely,
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        ...
                        and the shade is selected to match your
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        ...
                        to protect the prepared teeth while the
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        The custom restoration is checked for fit,
                        bite and appearance before being securely
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        Good oral hygiene, proper cleaning and
                        regular dental check-ups help protect your
                        crown or bridge for long-lasting results.
                    </p>
