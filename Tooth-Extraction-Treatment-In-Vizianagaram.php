...
$meta_title = "Tooth Extraction in Vizianagaram | Apple Dental Specialities";

$meta_description = "Safe and painless tooth extraction in Vizianagaram, including wisdom tooth removal. Modern techniques for quick recovery. Schedule your visit today.";
...
<section class="dsdl-hero text-center" style="position: relative; height: 40vh; background-image: url('images1/about-bg.jpg'); background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center;">
    ...
    <h1 style="position: relative; z-index: 2; color: white; font-size: 2.5rem; font-weight: bold; text-transform: uppercase;">Tooth Extraction</h1>
</section>
...
<!-- <section class="mt-5">
    ...
    <div class="container">
        <h2>Tooth Extraction in Vizianagaram</h2>
        <p>Tooth extraction is a dental procedure used to remove a damaged, decayed, or impacted tooth. It helps prevent the spread of infection and protects overall oral health. The procedure is performed under local anesthesia to reduce pain and ensure patient comfort in Tooth Extraction in Vizianagaram
        </p>
    </div>
</section> -->
            ...
            <div class="col-xl-6 col-lg-6 col-md-12"> 
                ...
                <div class="service_new_first_section_content"> 
                    ...
                    <p class="service_new_first_section_description"> 
                        ...
                        Tooth Extraction in Vizianagaram is a dental procedure used to remove 
                        a damaged, decayed, or impacted tooth. It helps prevent the spread of 
                        infection, protects surrounding teeth and gums, and supports better oral health. 
                        The procedure is performed under local anesthesia to reduce pain and ensure 
                        patient comfort throughout the treatment. 
...
<div class="container mt-5">
    <div class="row g-4 ">
        <div class="col-md-4">
            <div class="card shadow">
                <div class="overflow-hidden">
                    <img src="images1/services/services_img/teethextraction1.png" class="card-img-top" alt="Image 1">
                </div>
                <div class="card-body text-center">
                    <h5 class="card-title">Step 1:</h5>
                    <p class="card-text">  The dentist numbs the area with local anesthesia for a painless procedure.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="overflow-hidden">
                    <img src="images1/services/services_img/teethextraction2.png" class="card-img-top" alt="Image 2">
                </div>
                <div class="card-body text-center">
                    <h5 class="card-title">Step 2:</h5>
                    <p class="card-text"> The tooth is gently loosened and extracted using specialized dental tools.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="overflow-hidden">
                    <img src="images1/services/services_img/teethextraction.png" class="card-img-top" alt="Image 3">
                </div>
                <div class="card-body text-center">
                    <h5 >Step 3:</h5>
                    <p class="card-text">The socket is cleaned, and gauze is placed to control bleeding and aid healing.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <img src="images1/services/services_img/s8.png" class="card-img-top" alt="Tooth Extraction in Vizianagaram">
                    <div class="card-body">
...
<section class="service_new_second_section">
    ...
    <div class="service_new_second_section_left_note">
        ...
        <div>
            <span>RELIEVE PAIN</span>
            <span>REMOVE PROBLEM TEETH</span>
            <span>SUPPORT HEALING</span>
        </div>
    ...
    <div class="service_new_second_section_mirror">
        ...
        <img src="assets/img/services/tooth-extraction-side.png"
    ...
    <div class="container-fluid service_new_second_section_container">
        ...
        <div class="service_new_second_section_header">
            ...
            <div class="service_new_second_section_eyebrow">
                ...
                <p>
                    GENTLE CARE FOR SAFE TOOTH REMOVAL
                </p>
        ...
        <div class="service_new_second_section_process">
            ...
            <div class="service_new_second_section_center">
                ...
                <div class="service_new_second_section_center_circle">
                    ...
                    <div class="service_new_second_section_center_image">
                        ...
                        <img src="assets/img/services/tooth-extraction-process-main.png"
                             alt="Tooth Extraction Treatment in Vizianagaram">
                    ...
                    <div class="service_new_second_section_center_note">
                        ...
                        <span>Gentle Removal</span>
                        <span>Comfortable Healing</span>
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        We examine the affected tooth, discuss your
                        symptoms and medical history, and determine
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        Dental X-rays may be taken to assess the
                        tooth roots, surrounding bone and nearby
                        structures before extraction.
                    </p>
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        Local anesthesia is administered to numb
                        the treatment area and help keep you
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        The tooth is carefully loosened from the
                        surrounding tissues using appropriate
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        The affected tooth is carefully removed
                        while minimizing unnecessary pressure on
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <h3>
                        Socket Cleaning &amp; Protection
                    </h3>

                    <p>
                        The extraction area is checked and cleaned,
                        and the socket is protected to support
                        proper blood clot formation and healing.
                    </p>
            ...
            <article class="service_new_second_section_step
                ...
                <div class="service_new_second_section_step_content">
                    ...
                    <p>
                        ...
                        to support healing, maintain oral hygiene
