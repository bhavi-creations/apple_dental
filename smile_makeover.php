    ...
    <div class="row g-4">
        <div class="col-md-4">
            <div class="card shadow">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="card-text"> A detailed consultation is done to assess dental concerns and design a customized plan.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                ...
                <div class="card-body text-center">
                    <h5 >Step 3:</h5>
                    <p class="card-text">Final adjustments are made, ensuring a perfect, natural-looking smile.</p>
                </div>
            </div>
        </div>
    </div>
