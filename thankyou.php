...
<div class="main-content">
  <div class="card-box">
    ...
    <div class="hospital-name">Apple Dental Specialities </div>
    <div class="tagline">Vizianagaram &nbsp;|&nbsp; Your Smile, Our Pride</div>

    <div class="divider"></div>

    <h1 class="thank-heading">Thank You!</h1>
    <p class="thank-message">
      Thank you for consulting <strong>Apple Dental Specialities</strong>, Vizianagaram.<br />
